...
#include <vector>
#include <memory>
#include "GLViewTerrainModule.h" //GLView subclass instantiated to drive this simulation
...
int main( int argc, char* argv[] )
{
   ...
   do
   {
      std::unique_ptr< Aftr::GLViewTerrainModule > glView( Aftr::GLViewTerrainModule::New( args ) );
